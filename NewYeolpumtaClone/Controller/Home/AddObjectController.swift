...
//        deleteAll()
    ...
    @objc func makeTable() {
        ...
        let queryString = "INSERT INTO Objects (name) VALUES (?)"
    ...
    func deleteAll() {
        ...
        let deleteStatementString = "DROP TABLE Objects"
    ...
    @objc private func handleDismissal() {
        NotificationCenter.default.post(name: DidDismissAddObjectController, object: nil)
        navigationController?.popViewController(animated: true)
    }
    
    @objc private func didTapColorButton() {
        let vc = SelectColorController()
